...
function DownloadSection() {
  return (
    <div
      className={`w-full h-[210px] md:h-[190px] relative z-20 px-4 py-6 text-white flex flex-col items-center justify-around bg-[#003e5a] object-cover bg-cover  lg:bg-download-app`}
    >
      <div className="w-full h-full  lg:absolute top-0 left-0  bg-black bg-opacity-0 lg:bg-opacity-50" />
